...
class AccountMove(models.Model):
    ...
    def _get_reconciled_info_JSON_values(self):
        self.ensure_one()
        reconciled_vals = []
        for partials in self._get_reconciled_invoices_partials():
            for partial, amount, counterpart_line in partials:
    ...
    def action_post(self):
        # inherit of the function from account.move to validate a new invoice_data_time of an invoice
