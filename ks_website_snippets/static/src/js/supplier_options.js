odoo.define('ks_website_snippets.ks_website_supplier_options', function (require) {
 'use strict';
    ...
    options.registry.SpecialSupplier = options.registry.SelectTemplate.extend({
        /**
         * @constructor
         */
        init() {
            this._super(...arguments);
            this.selectTemplateWidgetName = 'ks_website_snippets_supplier';
        },
        async selectTemplate(previewMode, widgetValue, params) {
            await this._templatesLoading;
            // Call the controller method with parameters
            const response = await ajax.jsonRpc("/website/snippet/vendor/render", 'call', {
    ...
    return {
        SpecialSupplier: options.registry.SpecialSupplier,
    };
});