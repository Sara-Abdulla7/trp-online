...
class AccountMoveQRCode(models.Model):
    ...
    def _onchange_company_id(self):
        for rec in self:
            rec.invoice_terms_conditions_ar = rec.company_id.invoice_terms_conditions_ar
            rec.invoice_terms_conditions_en = rec.company_id.invoice_terms_conditions_en
    ...
    #     res = super(AccountMoveQRCode, self).action_post()
