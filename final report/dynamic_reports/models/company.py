...
class Company(models.Model):
    ...
    company_type = fields.Selection([
        ('keffah','Keffah Alsharq Contracting Group'),
        ('keffah_1', 'Keffah Alsharq Contracting Group(1)'),
        ('keffah_3', 'Keffah Alsharq Contracting Group(3)'),
        ('keffah_solutions', 'Keffah Solutions ITC Group'),
        ],string="Company Type")
